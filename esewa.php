...
<?php
    ...
    $tranuid = "ThankYou" . $pid . time();
    $signed_field_names = "total_amount,transaction_uuid,product_code";
    $signature_string = $total.",".$tranuid.",EPAYTEST";
 ...
 <input type="text" id="success_url" name="success_url" value="https://brp.com.np/esewa/success.php?q=su" required>
 <input type="text" id="failure_url" name="failure_url" value="https://brp.com.np/esewa/success.php?q=su" required>
